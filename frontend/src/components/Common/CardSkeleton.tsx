...
interface CardSkeletonProps {
     ...
     * `tile` is the square cover tile of the album grids, which is a different
     * shape entirely — the compact body would leave the grid jumping.
     */
    variant?: 'compact' | 'media' | 'tile';
}
